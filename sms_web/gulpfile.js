...
gulp.task('copy:extras', function () {
  return gulp.src([yeoman.app + '/*/.*', yeoman.app + '/404.*', yeoman.app + '/*.ico', yeoman.app + '/*.png'], { dot: true })
    .pipe(gulp.dest(yeoman.dist));
});
...
gulp.task('copy:styles', function () {
  return gulp.src(yeoman.app + '/styles/laydate/**/*')
    .pipe(gulp.dest(yeoman.dist + '/styles/laydate'));
});

gulp.task('copy:scripts', function () {
  return gulp.src(yeoman.app + '/scripts/extras/**/*')
    .pipe(gulp.dest(yeoman.dist + '/scripts/extras'));
});

gulp.task('build', ['clean:dist'], function () {
  runSequence(['images', 'copy:extras', 'copy:fonts', 'copy:styles', 'copy:scripts', 'client:build']);
});
